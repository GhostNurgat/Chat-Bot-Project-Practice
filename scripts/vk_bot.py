...
class VkBot:
    def __init__(self, user_id, questions, answers):
        ...
        self._KEYWORDS = ['долг', 'без проекта', 'без команды', 'нет проекта', 'нет команды', 'контрольные точки', 'итерации', 'teamproject', 'исследовательского трека', 'без проектов', 'контрольная точка', 'стартап', 'диплом', 'балл', 'оценил', 'пересдач', 'форм', 'тем', 'участник', 'команд']
